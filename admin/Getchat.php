...
if(isset($text)) {
    while ($row = mysqli_fetch_array($query, MYSQL_NUM)) {
        if ($row[1]=='admin') {
            ...
            echo "<div class=\"am-comment-meta\" style=\"background:#266905\">";
            echo "<a style='color: #ffffff;' href=\"#link-to-user\" class=\"am-comment-author\">$row[1]</a>";
            echo "<time datetime=\"\" title=\"最后的通信时间\" class=\"am-fr\">$row[2]</time>";
            echo "</div>";
            echo "</header>";
