...
<div class="container">
    ...
    <script>
        ...
        }// this function be use for get the url param.
        ...
        $("#chatSend").click(function(){
            ...
            xmlhttp.open("GET","../admin/chatsql.php?text="+str+"&&phone="+phone,true);
            $("#chattext").val('');
            xmlhttp.send();
        ...
        function GetChat() {  //获取消息函数
            ...
            GETChat.open("GET", "../admin/Getchat.php?GETChat=1"+"&&phone="+phone, true);
            GETChat.send();
